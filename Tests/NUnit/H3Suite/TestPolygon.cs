...
namespace TestSuite
{
    ...
    public class TestPolygon
    {
        ...
        {
            var verts = MakeGeoCoordArray(new double[,] {{0, 0}, {0, 0.4}, {0.4, 0.4}, {0.4, 0}});
            var outer = CreateLinkedLoop(verts);

            var verts2 = MakeGeoCoordArray(new double[,] {{0.1, 0.1}, {0.2, 0.2}, {0.1, 0.2}});
            var inner1 = CreateLinkedLoop(verts2);

            var verts3 = MakeGeoCoordArray(new double[,] {{0.2, 0.2}, {0.3, 0.3}, {0.2, 0.3}});
